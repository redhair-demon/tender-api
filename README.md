## Про проект
В данном репозитории находятся 2 реализации тестового задания - на Java 17 и Go 1.22

Dockerfile - для запуска Go-реализации
DockerfileJava - для запуска Java-реализации
